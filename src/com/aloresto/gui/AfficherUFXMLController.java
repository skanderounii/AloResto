 ...
 * @author Chaouki-NH
 */
public class AfficherUFXMLController implements Initializable {

    @FXML
    private ListView<User> ListeU;
     ...
     UserService us = new UserService();
        ...
        try {
            ...
            for (int i = 0; i < users.size(); i++) {
                ListeU.getItems().add(users.get(i)); 
            }
    ...
    @FXML
    private void QuitterU(ActionEvent event) {
