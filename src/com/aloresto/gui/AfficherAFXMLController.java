 ...
 * @author Chaouki-NH
 */
public class AfficherAFXMLController implements Initializable {

    @FXML
    private ListView<Admin> ListeA;
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     AdminService ad = new AdminService();
        ...
        try {
            ...
            List<Admin> users =  ad.afficher();
            
            for (int i = 0; i < users.size(); i++) {
                ListeA.getItems().add(users.get(i)); 
            }
    ...
    @FXML
    private void QuitterA(ActionEvent event) {
